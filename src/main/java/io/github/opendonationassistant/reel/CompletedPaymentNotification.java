...
public class CompletedPaymentNotification {
  ...
  public String toString() {
    return "{\"_type\"=\"CompletedPaymentNotification\",\"id\"=\"" + id + "\", nickname\"=\"" + nickname
        + "\", message\"=\"" + message + "\", recipientId\"=\"" + recipientId + "\", amount\"=\"" + amount
        + "\", confirmation\"=\"" + confirmation + "\", failed\"=\"" + failed + "\", attachments\"=\"" + attachments
